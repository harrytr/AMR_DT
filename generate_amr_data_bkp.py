    ...
    *,
    ...
    for w, k in admit_plan.items():
        ...
        for _ in range(int(k)):
            ...
            # preserve your original “CR first, then CS” logic
            if r < p_cr:
...
def main() -> None:
    ...
    # Shock mode controls (random per region/run unless you extend to set fixed start/duration)
